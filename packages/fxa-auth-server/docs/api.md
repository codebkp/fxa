...
* [API endpoints](#api-endpoints)
  ...
  * [Devices and sessions](#devices-and-sessions)
    ...
    * [POST /account/attached_clients/destroy (:lock: sessionToken)](#get-accountattached_clientsdestroy)
...
**DEPRECATED**: Please use [GET /account/attached_clients (:lock: sessionToken)](#get-accountattached_clients) instead.
