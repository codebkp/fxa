...
module.exports = (log, db, config, devices, oauthdb) => {
  ...
  // XXX TODO: make this a shared helper with devices routes.
    ...
    },
    {
      ...
      handler: async function (request) {
        ...
        if (request.payload.deviceId) {
          ...
          // XXX TODO: need to confirm it has the same uid as the one on the request
          await true;
        }
